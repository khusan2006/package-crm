...
urlpatterns = [
    ...
    path("payments/", crm_views.payment_list, name="payment_list"),
    path("payments/export/", crm_views.payment_export, name="payment_export"),
    path("payments/<int:pk>/delete/", crm_views.payment_delete, name="payment_delete"),
    path("audit/", crm_views.audit_list, name="audit_list"),
    path("reports/", crm_views.report_view, name="report_view"),
    path("reports/export/", crm_views.report_export, name="report_export"),
